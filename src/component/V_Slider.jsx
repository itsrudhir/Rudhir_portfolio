    ...
    <div className="min-h-screen bg-gray-800 text-gray-100 flex">
        ...
        {items.map((item, index) => (
          ...
          >
            ...
            <div
              ...
              style={{ maxHeight: expandedIndex === index ? "1000px" : "0px" }}
            >
      ...
      <div className="w-3/4 p-4">
        ...
        >
          ...
          <div className="text-white font-bold w-5/6 p-5 text-justify ">
            <h2>
              <b className="text-4xl">Lung Sound Classification :</b>Designed a
              Multilayered CNN architecture & 5 ML models for multiclass
        ...
        >
          ...
          <div className="text-white font-bold w-5/6 p-5 text-justify ">
            <h2>
              ...
              Haar-Cascades, achieving 99.94% accuracy. It analyzes live camera
              feeds to accurately identify emotions like happiness, sadness,
              anger, and surprise, demonstrating advanced computer vision
              capabilities.
            </h2>
          </div>
        </div>
        ...
        >
          ...
          <div className="text-white font-bold w-5/6 p-5 text-justify ">
            <h2>
              <b className="text-4xl">
                Assigned as the President of Bears 'N' Bulls NITR
              </b>
            </h2>
          </div>
        </div>
        ...
        >
          ...
          <div className="text-white font-bold w-5/6 p-5 text-justify ">
            <h2>
              <b className="text-4xl">Assesed by IBM in Supervised ML & EDA</b>
            </h2>
          </div>
        </div>
